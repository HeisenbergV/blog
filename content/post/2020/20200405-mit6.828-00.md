...
## 前言
写一个操作系统一直是我的梦想，[MIT 6.828](https://pdos.csail.mit.edu/6.828/2019/)是最好的课程之一。我会根据这个学习路线，为xv6系统做扩展，并制作属于自己操作系统。这将会是一系列课程，来记录我的学习与实践过程：
...
## 进度目录
LEC 1: 
[环境搭建](/post/2020/20200406-mit6.828-01) & [Lab1:Util](/post/2020/20200407-mit6.828-lab1)
